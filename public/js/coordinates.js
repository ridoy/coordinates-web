...
$('#join-button').click(function() {
    ...
    function initGame() {
        ...
        $('#viewport').on('mousemove', function(event) {
            ...
            // Which position on the board is the least distant from the mouse's position?
            var minDistance = canvas.width;
            for (var r = 0; r < numRows; r++) {
                for (var c = 0; c < numCols; c++) {
                    var xLength  = event.offsetX - grid[r][c].x;
                    var yLength  = event.offsetY - grid[r][c].y;
        ...
        function drawCursor(x, y) {
            ctx.strokeStyle = (playerNum === 1) ? 'rgb(89, 97, 227)' : 'rgb(162, 30, 18)';
            ctx.beginPath();
        ...
        function drawPiece(r, c) {
            ...
            ctx.beginPath();
            ctx.arc(x, y, 10, 0, Math.PI * 2);
            ctx.strokeStyle = (player === 1) ? 'rgb(89, 97, 227)' : 'rgb(162, 30, 18)';
            ctx.fillStyle   = (player === 1) ? 'rgb(89, 97, 227)' : 'rgb(162, 30, 18)';
